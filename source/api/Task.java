...
public interface Task<T> {
	 ...
	 * are consumed by a {@link api.Space Space} object by queueing them again
	 * for execution on different machine in the cluster. If the base case of
	 ...
	 * {@link api.Space Space} object to switch the status of a subtask after
	 * the from DECOMPOSE (after the 'Divide' phase) into COMPOSE (to start the
	 * 'Conquer' phase).
	 * 
	 * 
	 */
